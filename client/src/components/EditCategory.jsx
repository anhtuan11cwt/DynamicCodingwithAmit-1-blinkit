...
const EditCategory = ({ close, dataCategory, onSuccess }) => {
  const [data, setData] = useState({
    _id: dataCategory._id,
    imageFile: null,
    imagePreview: dataCategory.image || "",
  ...
  const handleSubmit = async (e) => {
    ...
    if (!data.name || (!data.imageFile && !data.imageUrl)) {
    ...
    try {
      ...
      const response = await Axios({
        ...
        data: { _id: data._id, image: imageUrl, name: data.name },
      });
        ...
        <form className="grid gap-4" onSubmit={handleSubmit}>
              ...
              >
                ...
                >
                  <label
                    ...
                    htmlFor="editCategoryImageReplace"
                  >
          ...
          <div className="mt-1 flex gap-3">
            ...
            <button
              ...
              disabled={submitting || !data.name || !data.imagePreview}
              type="submit"
            >
              {submitting ? (
                <Loader2
